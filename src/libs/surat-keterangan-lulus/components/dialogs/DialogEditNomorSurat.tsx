...
import { updateNomorSuratKeteranganLulus } from 'src/stores/surat-keterangan-lulus/suratKeteranganLulusAction'
...
const DialogEditNomorSurat = ({ open, onClose, values }: DialogEditNomorSuratProps) => {
  ...
  const onSubmit = handleSubmit(async (value: any) => {
    ...
    // @ts-ignore
    await dispatch(updateNomorSuratKeteranganLulus({ data: body, id: values?.ulid })).then((res: any) => {
