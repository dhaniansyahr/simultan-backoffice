...
import { createSuratKeteranganLulus } from 'src/stores/surat-keterangan-lulus/suratKeteranganLulusAction'
...
const SuratKeteranganLulusCreateContainer = () => {
  ...
  const onSubmit = handleSubmit(async (value: any) => {
    ...
    const body: any = {
      tipeSurat: value?.tipeSurat,
      deskripsi: value?.deskripsi,
      dokumenTranskrip: value?.dokumenTranskrip
    }

    // @ts-ignore
    await dispatch(createSuratKeteranganLulus({ data: body })).then((res: any) => {
      if (res?.meta?.requestStatus !== 'fulfilled') {
        setIsLoading(false)
        toast.dismiss()
  ...
  return (
    <>
      <Card>
        <HeaderPage title='Buat Surat Keterangan Lulus' isDetail={true} />
              ...
              <Grid item xs={6}>
                ...
                >
                  ...
                  <Typography variant='body2'>
                    Pastikan dokumen yang diupload sesuai dengan ketentuan yang berlaku. Surat keterangan lulus akan
                    diproses setelah semua dokumen persyaratan lengkap dan telah diverifikasi.
                  </Typography>
                </Card>
              </Grid>
...
export default SuratKeteranganLulusCreateContainer
