...
import { createRekomendasiBeasiswa } from 'src/stores/rekomendasi-beasiswa/rekomendasiBeasiswaAction'
...
const RekomendasiBeasiswaCreateContainer = () => {
  ...
  const onSubmit = handleSubmit(async (value: any) => {
    ...
    // @ts-ignore
    await dispatch(createRekomendasiBeasiswa({ data: body })).then((res: any) => {
      if (res?.meta?.requestStatus !== 'fulfilled') {
        setIsLoading(false)
        toast.dismiss()
  ...
  return (
    <>
      <Card>
        <HeaderPage title='Buat Rekomendasi Beasiswa' isDetail={true} />
...
export default RekomendasiBeasiswaCreateContainer
