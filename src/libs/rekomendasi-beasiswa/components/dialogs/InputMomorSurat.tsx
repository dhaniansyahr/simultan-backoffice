...
import { inputNomorSuratRekomendasiBeasiswa } from 'src/stores/rekomendasi-beasiswa/rekomendasiBeasiswaAction'
...
const InputNomorSuratDialog = ({ open, onClose, values }: InputNomorSuratDialogProps) => {
  ...
  const onSubmit = handleSubmit(async (value: any) => {
    ...
    // @ts-ignore
    await dispatch(inputNomorSuratRekomendasiBeasiswa({ data: body, id: values?.ulid })).then((res: any) => {
