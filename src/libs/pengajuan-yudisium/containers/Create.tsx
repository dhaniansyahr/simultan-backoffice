...
const CreateContainer = () => {
  ...
  return (
    <>
      <Card>
        <HeaderPage title='Buat Pengajuan Yudisium' isDetail={true} />
              ...
              <Grid item xs={6}>
                ...
                >
                  ...
                  <ul>
                    ...
                    <li>
                      <Typography variant='body2'>
                        Mahasiswa mengumpulkan semua berkas persyaratam dan diserahkan pada sub bagian akademik fakultas
                      </Typography>
                    </li>
                  </ul>
                </Card>
